...
try:
    from opencc_dict import zh2Hant, zh2Hans
    from dict_plus import sim_to_tra, tra_to_sim
except ImportError:
    from util.opencc_dict import zh2Hant, zh2Hans
    from util.dict_plus import sim_to_tra, tra_to_sim
...
for key in tra_to_sim.keys():
    zh2Hans[key] = tra_to_sim[key]
for key in sim_to_tra.keys():
    zh2Hant[key] = sim_to_tra[key]

registery('zh-hant', zh2Hant)
registery('zh-hans', zh2Hans)
del zh2Hant, zh2Hans, tra_to_sim, sim_to_tra
